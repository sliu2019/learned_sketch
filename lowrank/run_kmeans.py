...
def load_S(S_path, n):
    ...
    exp_fldr = os.path.join("/home/me/research/big-lowrank", S_path)
...
if __name__ == "__main__":
    ...
    """
    kmeans_folder_pth = "/home/me/research/big-kmeans/"
    num_rand_trials = 1

    save_folder_nm = "debug"

    n_cluster_list = [3, 6, 10]
    dataset_spec_list = [["video", "mit"], ["video", "eagle"], ["video", "friends"], ["hyper"]]
    sketch_method_list = ["learned_CS_oblivious", "random_CS_oblivious", "col_sampling", "exact_SVD"]


    S_fpth_dict = {"learned_CS_oblivious": {("hyper", ): {3: "path/to/S"}, ("video", "mit"): {6: "path/to/other/S"}}}
